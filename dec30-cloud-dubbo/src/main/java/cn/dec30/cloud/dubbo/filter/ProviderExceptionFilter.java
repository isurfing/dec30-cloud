...
import cn.dec30.cloud.base.util.ThrowableUtil;
    ...
    public void onResponse(Result appResponse, Invoker<?> invoker, Invocation invocation) {
        if(appResponse.hasException()) {
            ...
            if(exe instanceof RpcInvokeException rExe) {
                appResponse.setException(new RpcInvokeException(rExe.getCode(), rExe.getMsg(), ThrowableUtil.genStackString(rExe)));
            }
        }
    }
